...
import { buttonDisable, buttonEnable, storePaymentDetails } from './payment';
...
export const placeOrder = (data: any, response?: any) => {
	return async (dispatch: Dispatch) => {
		...
		try {
			...
			response && dispatch<any>(storePaymentDetails(response, res.data));
